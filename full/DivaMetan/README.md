...
#### [Q. ギフト・スパチャされた時にだけ発動させたい](template/faq/21_LimitEdit/faq_2101_Gift.md)

#### [Q. メンバー限定で発動させたい](template/faq/21_LimitEdit/faq_2102_Member.md)

#### [Q. 1 日 1 回と、回数を制限したい](template/faq/21_LimitEdit/faq_2103_Limit.md)

#### [Q. 配信者をおみくじから外すには？](template/faq/21_LimitEdit/faq_2104_Owner.md)

#### [Q. 特定のおみくじを、一時的にオフにしたい](template/faq/21_LimitEdit/faq_2103_Limit.md)

#### [Q. 同じ人に何回もおみくじされると困る](template/faq/21_LimitEdit/faq_2106_LimitOne.md)

#### [Q. 特定のユーザーを制限したい](template/faq/21_LimitEdit/faq_2107_LimitOther.md)
